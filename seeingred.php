...
<head>
	<meta charset="UTF-8">
	<title>Seeing Red | Dhruv Mehra</title>
	...
	<link rel="canonical" href="https://www.dmehra.com/seeingred.html">
...
<body>
	...
	<section class="atl">
	  <h3>SEEING RED</h3>
		<div class="atlcreds">
			<p><span class="role">writer: </span>Hannah Lindvall</p>
			<p><span class="role">director: </span>Claire Stevens</p>
		</div>
		<ol class="specs">
	...
	<section class="gallery">
		...
		<div class="row">
			<div class="column">
				<img src="films/seeingred/couch.jpg" alt="couch" onclick="openModal();currentSlide(1)" class="hover-shadow">
				</div>
			<div class="column">
				<img src="films/seeingred/eyes.jpg" alt="eyes" onclick="openModal();currentSlide(2)" class="hover-shadow">
				</div>
			<div class="column">
				<img src="films/seeingred/bed.jpg" alt="bed" onclick="openModal();currentSlide(3)" class="hover-shadow">
			</div>
		</div>
	</section>
	...
	<div id="myModal" class="modal">
		<div  class="lightbox">
		  <div class="modal-content">
		    <div class="mySlides">
		      <img src="films/seeingred/couch.jpg">
		    </div>
		    <div class="mySlides">
		      <img src="films/seeingred/eyes.jpg">
		    </div>
		    <div class="mySlides">
		      <img src="films/seeingred/bed.jpg">
		    </div>
				<div class="mySlides">
		      <img src="films/seeingred/bed.jpg">
		    </div>
	...
	<section class="credits">
			<div class="logline">
				<p>A Tinder date gone wrong...</p>
			</div>
			<div class="btl">
				<p><span class="role">cinematographer: </span>Dhruv Mehra</p>
				<p><span class="role">gaffer: </span>Conor Metz</p>
				<p><span class="role">1st ac: </span>Hannah Lindvall</p>
			</div>
	</section>

	<!-- buttons -->
	<section class="buttons">
		<div class="back"><a href="pawel.html">PREV</a></div>
		<div class="projects"><a href="index.html">BACK TO WORK</a></div>
		<div class="forward"><a href="beenawhile.html">NEXT</a></div>
	</section>
